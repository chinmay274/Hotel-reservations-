...
class HOTEL_MANGMENT_checkin:
    def __init__(self):
        ...
        self.Labelframe1.configure(background="#FF3300")
        ...
        self.Label1.configure(activebackground="#FF0000")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#FF0000")
        ...
        self.Label2.configure(activebackground="#FF0000")
