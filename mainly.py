...
class HOTEL_MANAGEMENT:
    def __init__(self):
        ...
        self.Message6.configure(background="#FF3300")
        ...
        self.Button2.configure(highlightbackground="#CC0000")
        ...
        self.Button3.configure(highlightbackground="#CC0000")
        ...
        self.Button4.configure(activebackground="#CC0000")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#CC0000")
        self.Button4.configure(disabledforeground="#bfbfbf")
        self.Button4.configure(font=font14)
        self.Button4.configure(foreground="#000000")
        self.Button4.configure(highlightbackground="#CC0000")
        ...
        self.Button5.configure(highlightbackground="#CC0000")
        self.Button5.configure(highlightcolor="black")
        self.Button5.configure(pady="0")
        self.Button5.configure(text='''GET INFO OF A GUEST''')
        ...
        self.Button6.configure(activebackground="#CC0000")
        self.Button6.configure(activeforeground="#000000")
        self.Button6.configure(background="#CC0000")
        self.Button6.configure(disabledforeground="#bfbfbf")
        self.Button6.configure(font=font14)
        self.Button6.configure(foreground="#000000")
        self.Button6.configure(highlightbackground="#CC0000")
