...
class HOTEL_MANAGEMENT_checkin:
    ...
    def __init__(self):
        ...
        def tor(self):
            ...
            if self.ch == 1:
                self.price = self.price + (2000 * self.days * 0.80)
                m[0] = 1
            elif self.ch == 2:
                self.price = self.price + (1500 * self.days * 0.80)
                m[0] = 2
            elif self.ch == 3:
                self.price = self.price + (1000 * self.days * 0.80)
                m[0] = 3
            elif self.ch == 4:
                self.price = self.price + (500 * self.days * 0.80)
                m[0] = 4

        def meal_option(self):
            op = self.p
            if op == 1:
                ...
                self.price = self.price - ((self.price * 10) / 100)
                self.Text1.insert(INSERT, "25% discount""\n")
        ...
        def submit_clicked():
            if self.var1.get()==1 and self.var2.get()==0 and self.var3.get()==0 and self.var4.get()==0 and self.var5.get()==0 and self.var6.get()==1 and self.var7.get() == 0:
                self.ch=1
                self.p=1
            ...
            elif self.var1.get() == 1 and self.var2.get() == 0 and self.var3.get() == 0 and self.var4.get() == 0 and self.var5.get() == 0 and self.var6.get() == 0 and self.var7.get() == 1:
                self.ch = 1
                self.p = 2
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 1 and self.var2.get() == 0 and self.var3.get() == 0 and self.var4.get() == 0 and self.var5.get() == 1 and self.var6.get() == 0 and self.var7.get() == 0:
                self.ch = 1
                self.p = 3
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 1 and self.var3.get() == 0 and self.var4.get() == 0 and self.var5.get() == 0 and self.var6.get() ==1 and self.var7.get() == 0:
                self.ch = 2
                self.p = 1
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 1 and self.var3.get() == 0 and self.var4.get() == 0 and self.var5.get() == 0 and self.var6.get() == 0 and self.var7.get() == 1:
                self.ch = 2
                self.p = 2
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 1 and self.var3.get() == 0 and self.var4.get() == 0 and self.var5.get() == 1 and self.var6.get() == 0 and self.var7.get() == 0:
                self.ch = 2
                self.p = 3
            ...
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 1 and self.var4.get() == 0 and self.var5.get() == 0 and self.var6.get() == 1 and self.var7.get() == 0:
                self.ch = 3
                self.p = 1
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 1 and self.var4.get() == 0 and self.var5.get() == 0 and self.var6.get() == 0 and self.var7.get() == 1:
                self.ch = 3
                self.p = 2
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 1 and self.var4.get() == 0 and self.var5.get() == 1 and self.var6.get() == 0 and self.var7.get() == 0:
                self.ch = 3
                self.p = 3
                ...
                meal_option(self)
                bill(self)
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 0 and self.var4.get() == 1 and self.var5.get() == 0 and self.var6.get() == 1 and self.var7.get() == 0:
                self.ch = 4
                self.p = 1
                ...
                meal_option(self)
                bill(self) 
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 0 and self.var4.get() == 1 and self.var5.get() == 0 and self.var6.get() == 0 and self.var7.get() == 1:
                self.ch = 4
                self.p = 2
                ...
                meal_option(self)
                bill(self) 
            elif self.var1.get() == 0 and self.var2.get() == 0 and self.var3.get() == 0 and self.var4.get() == 1 and self.var5.get() == 1 and self.var6.get() == 0 and self.var7.get() == 0:
                self.ch = 4
                self.p = 3
        ...
        root.configure(background="#990033")
        ...
        self.Text1.configure(highlightbackground="#FFFFCC")
        ...
        self.Frame1.configure(relief=GROOVE)
        self.Frame1.configure(background="#FF3300")
        ...
        self.Message1.configure(background="#FF3300")
        ...
        self.Message2.place(relx=0.50, rely=0.12, relheight=0.74, relwidth=0.07)
        self.Message2.configure(background="#FF3300")
        ...
        self.Message3.place(relx=0.57, rely=0.13, relheight=0.79, relwidth=0.35)
        self.Message3.configure(background="#FF3300")
        ...
        self.Frame2.configure(relief=GROOVE)
        self.Frame2.configure(background="#CC0000")
        ...
        self.Label3.configure(background="#CC0000")
        ...
        self.Label4.configure(background="#CC0000")
        ...
        self.Label5.configure(background="#CC0000")
        ...
        self.Label6.configure(background="#CC0000")
        ...
        self.Label7.configure(background="#CC0000")
        ...
        self.Message5.configure(background="#CC0000")
        ...
        self.Message6.configure(background="#CC0000")
        ...
        self.Checkbutton1.place(relx=0.15, rely=0.58, relheight=0.17
                , relwidth=0.14)
        self.Checkbutton1.configure(activebackground="#CC0000")
        self.Checkbutton1.configure(activeforeground="#000000")
        self.Checkbutton1.configure(background="#CC0000")
        ...
        self.Checkbutton2.place(relx=0.15, rely=0.72, relheight=0.11
                , relwidth=0.21)
        self.Checkbutton2.configure(activebackground="#CC0000")
        self.Checkbutton2.configure(activeforeground="#000000")
        self.Checkbutton2.configure(background="#CC0000")
        ...
        self.Checkbutton3.place(relx=0.5, rely=0.6, relheight=0.11
                , relwidth=0.16)
        self.Checkbutton3.configure(activebackground="#CC0000")
        self.Checkbutton3.configure(activeforeground="#000000")
        self.Checkbutton3.configure(background="#CC0000")
        ...
        self.Checkbutton4.place(relx=0.5, rely=0.71, relheight=0.11
                , relwidth=0.12)
        self.Checkbutton4.configure(activebackground="#CC0000")
        self.Checkbutton4.configure(activeforeground="#000000")
        self.Checkbutton4.configure(background="#CC0000")
        ...
        self.var5 = IntVar()
        self.Checkbutton5.place(relx=0.541, rely=0.89, relheight=0.1
                                , relwidth=0.16)
        self.Checkbutton5.configure(activebackground="#CC0000")
        self.Checkbutton5.configure(activeforeground="#000000")
        self.Checkbutton5.configure(background="#CC0000")
        ...
        self.Checkbutton5.configure(text='''DINNER''')
        self.Checkbutton5.configure(variable=self.var5)

        self.Checkbutton6 = Checkbutton(self.Frame2)
        self.var6 = IntVar()
        self.Checkbutton6.place(relx=0.143, rely=0.89, relheight=0.1
                                , relwidth=0.24)
        self.Checkbutton6.configure(activebackground="#CC0000")
        self.Checkbutton6.configure(activeforeground="#000000")
        self.Checkbutton6.configure(background="#CC0000")
        ...
        self.Checkbutton6.configure(text='''BREAKFAST''')
        self.Checkbutton6.configure(variable=self.var6)

        self.Checkbutton7 = Checkbutton(self.Frame2)
        self.var7 = IntVar()
        self.Checkbutton7.place(relx=0.330, rely=0.89, relheight=0.1
                                , relwidth=0.24)
        self.Checkbutton7.configure(activebackground="#CC0000")
        self.Checkbutton7.configure(activeforeground="#000000")
        self.Checkbutton7.configure(background="#CC0000")
        self.Checkbutton7.configure(disabledforeground="#bfbfbf")
        self.Checkbutton7.configure(font=font16)
        self.Checkbutton7.configure(foreground="#000000")
        self.Checkbutton7.configure(highlightbackground="#ffffff")
        self.Checkbutton7.configure(highlightcolor="black")
        self.Checkbutton7.configure(justify=LEFT)
        self.Checkbutton7.configure(text='''LUNCH''')
        self.Checkbutton7.configure(variable=self.var7)


        self.Message7 = Message(self.Frame2)
        self.Message7.place(relx=0.28, rely=0.46, relheight=0.11, relwidth=0.04)
        self.Message7.configure(background="#CC0000")
        ...
        self.Button1.configure(activebackground="#CC0000")
        self.Button1.configure(activeforeground="#000000")
        self.Button1.configure(background="#CC0000")
        ...
        self.Button2.configure(activebackground="#CC0000")
        self.Button2.configure(activeforeground="#000000")
        self.Button2.configure(background="#CC0000")
        ...
        self.Button3.configure(activebackground="#CC0000")
        self.Button3.configure(activeforeground="#000000")
        self.Button3.configure(background="#CC0000")
        ...
        self.Button4.configure(activebackground="#FF3300")
        self.Button4.configure(activeforeground="#000000")
        self.Button4.configure(background="#FF3300")
        ...
        self.Label1.place(relx=0.05, rely=0.42, height=44, width=260)
        self.Label1.configure(background="#CC0000")
        ...
        self.Message8.configure(background="#CC0000")
        ...
        self.Button5.configure(activebackground="#CC0000")
        self.Button5.configure(activeforeground="#000000")
        self.Button5.configure(background="#CC0000")
